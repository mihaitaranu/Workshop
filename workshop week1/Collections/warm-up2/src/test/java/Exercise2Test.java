...
/**
 * Created by radu992 on 20.04.2015.
 */
public class Exercise2Test {
    private Student[] students = {new Student(0, "Popescu", "Mihai", 8.66),
            new Student(1, "Ionescu", "Ion", 7.92),
            new Student(2, "Popa", "Cristina", 9.34),
            new Student(3, "Barbu", "Mihai", 5.01),
            new Student(0, "Popescu", "Mihai", 8.66),
            new Student(4, "Serban", "Alin", 9.66),
            new Student(5, "Georgescu", "Andreea", 5.01),
            new Student(2, "Popa", "Cristina", 9.34),
            new Student(0, "Popescu", "Mihai", 8.66),};
    ...
    public void testHashCodeMethod() throws Exception {
        ...
        Student student4 = new Student(1, "Mihai", "Popescu", 8.98); // Mihai Popescu with other averageGrade
