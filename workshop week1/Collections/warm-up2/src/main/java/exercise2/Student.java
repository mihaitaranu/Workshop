...
public class Student {
    ...
    public boolean equals(Object o) {
        ...
        if(!this.id.equals(student.id)||!this.firstName.equals(student.firstName)||!this.lastName.equals(student.lastName)||!this.averageGrade.equals(student.averageGrade)){
            return false;
        }
        return true;
